...
public class ContDTO {
    ...
    public void setInsuidtype(String insuidtype) {
        this.insuidtype = insuidtype;
    }
    ...
    public void setInsuidno(String insuidno) {
        this.insuidno = insuidno;
    }

    public Date getInsubirthday() {
        return insubirthday;
    }

    public void setInsubirthday(Date insubirthday) {
        this.insubirthday = insubirthday;
    }
