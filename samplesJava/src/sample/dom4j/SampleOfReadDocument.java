...
public class SampleOfReadDocument {
    ...
    public MultAcceptDTO transferBySelect(Document doc, String funcflag) {
        ...
        for (Node grpContNode : grpContList) {
            ...
            Node insuNameNode = grpContNode.selectSingleNode("LCConts/LCCont/LCInsureds/LCInsured/Name");
            Node insuSexNode = grpContNode.selectSingleNode("LCConts/LCCont/LCInsureds/LCInsured/Sex");
            Node insuBirthdayNode = grpContNode.selectSingleNode("LCConts/LCCont/LCInsureds/LCInsured/Birthday");
            Node insuIDTypeNode = grpContNode.selectSingleNode("LCConts/LCCont/LCInsureds/LCInsured/IDType");
            Node insuIDNoNode = grpContNode.selectSingleNode("LCConts/LCCont/LCInsureds/LCInsured/IDNo");
            ...
            Node riskCodeNode = grpContNode.selectSingleNode("LCConts/LCCont/LCInsureds/LCInsured/Risks/Risk/RiskCode");
    ...
    public MultAcceptDTO transferByElement(Document doc, String funcflag) {
        ...
        List<Element> grpContList = grpContsElement.element("LCGrpCont").element("LCConts").elements("LCCont");
        ...
        Iterator it = grpContList.iterator(); it.hasNext();) {
            ...
            String riskCodeNode = lcinsuredElement.element("Risks").element("Risk").elementText("RiskCode");
    ...
    public static void main(String[] args) throws DocumentException {
        ...
        //        cost = System.nanoTime() - startTime;
        //        logger.info("transferBySelect ended. cost " + cost / 1000000
        //                + " milliseconds.");
